...
var employeeList = [
    {
        ...
        "ID": "#TWE1001528",
        "Name": "Willie Torres",
        "img": "/static/images/users/user-1.jpg",
    ...
    },
    {
        ...
        "img": "/static/images/users/user-2.jpg",
    ...
    },
    {
        ...
        "ID": "#TWE1001506",
        "Name": "Tonya Johnson",
        "img": "/static/images/users/user-3.jpg",
    ...
    },
    {
        ...
        "ID": "#TWE1001502",
        "Name": "Jose White",
        "img": "/static/images/users/user-4.jpg",
            ...
            employeeTable.add({
                ...
                Name: `<a href="#!" class="flex items-center gap-3">
                            <div div class="w-6 h-6 rounded-full shrink-0 bg-slate-100">
                                <img src="/static/images/users/user-dummy-img.jpg" alt="" class="h-6 rounded-full">
                            </div>
